...
class Game: 
    def __init__(self): 
        ...
        pygame.mixer.music.load("Sounds/foggysunrise-glass-gardens-loop-371924.mp3")
        pygame.mixer.music.play(-1)  # Looping the music
    ...
    def draw(self, screen): 
        ...
        if self.next_block.id == 3:
            self.next_block.draw(screen, 260, 290)
